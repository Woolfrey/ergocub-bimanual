...
class CommandServer : public CommandInterface
{
	public:
		...
		CommandServer(BimanualControl *_robot,
		...
		bool release_object() { return this->robot->release_grasp(); }
	...
	private:
		...
		BimanualControl *robot;                                                             // Pointer to robot object
...
/*		
	try // to start up the robot
	{
		...
		BimanualControl robot(pathToURDF, jointNames, portList, robotModel);                // Start up the robot
